        ...
        if(r.code==200){
            ...
            if(data.length>0){
                ...
                for (var i=0;i<data.length;i++){
                        ...
                        '<div class="cbp_tmlabel"><h2>'+(((new Date().getTime()/1000)>data[i].end)?'<span class="am-icon-check-square-o"></span> ':"")+data[i].name+'</h2><p><span class="am-icon-clock-o"></span> '+date(data[i].start*1000)+'~'+hour(data[i].end*1000)+'</p><p><span class="am-icon-location-arrow"></span> '+data[i].building+data[i].classroom+'</p></div></li>';
                ...
                $(".main").html('<div style="margin-top:30px;color:rgba(0,0,0,0.4);text-align:center"><p>^_^当前没有考试</p><p>最后更新时间:'+ date(r.data.updateAt*1000)+'</p> </div><div class="radiusButton refresh"><i class="am-icon-refresh"></i></div>');
